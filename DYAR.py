...
def info():
	prints(f"""{B2}╭─────────────────────╮{B2}╭───────────────╮
{B2}│ {P2}Author : Bemnat × OKENWA{B2} │{B2}│ {P2}Version : 5.1{B2} │
{B2}╰─────────────────────╯{B2}╰───────────────╯""")
...
def banner():
  ...
  ____                             _   
 |  _ \                           | |  
 | |_) | ___ _ __ ___  _ __   __ _| |_ 
 |  _ < / _ \ '_ ` _ \| '_ \ / _` | __|
 | |_) |  __/ | | | | | | | | (_| | |_ 
 |____/ \___|_| |_| |_|_| |_|\__,_|\__|
                                       
                                       
         Made By {M2}bemnat{P2}Coder""",width=80,style=f"{color_panel}"))
def login():
	try:
